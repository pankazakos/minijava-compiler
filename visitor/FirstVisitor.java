...
public class FirstVisitor extends GJDepthFirst<String, String>{
    ...
    public int ComputeMethodOffset(String classname, String methodtype, String methodname){
