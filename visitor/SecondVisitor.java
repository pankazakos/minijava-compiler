...
public class SecondVisitor extends GJDepthFirst<String, String>{
    ...
    */
    ...
    public String visit(AssignmentStatement n, String argu) throws Exception{
        ...
        //Check whether the type of rvalue matches the type of lvalue or matches a type of parentclass
    ...
    */
    ...
    public String visit(MessageSend n, String argu) throws Exception {
        ...
        //Check if number of arguments is the same with the number of arguments of the method protocol
        if(n.f4.present()){
            ...
            if(ArgTypes.length != st.classes.get(ClassType).methods.get(methodname).arguments.size()){
                throw new Exception("The method " + methodname + " is not applicable for the number of arguments given");
            }
            //Convert LinkeHashMap values to List
            List<String> lstArgs = new ArrayList<String>(st.classes.get(ClassType).methods.get(methodname).arguments.values());
    
            //For each argument check whether the type of the argument given matches the type of the class or a type of a parent class
            int index = 0;
